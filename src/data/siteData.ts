...
export const partners: Partner[] = [
  {
    id: 'a-mute',
    name: 'A-Mute',
    logo: '/logos/partners/a-mute.png',
  ...
  },
  {
    ...
    logo: '/logos/partners/aj-atelier-des-cuivres.png',
    url: 'https://aj-atelierdescuivres.fr/',
  },
  { id: 'a-jaminet', name: 'A. Jaminet', logo: '/logos/partners/a-jaminet.png', url: 'https://www.ajaminet.fr/' },
  { id: 'donat', name: 'Donat — Embouchures pour cuivres', logo: '/logos/partners/donat.png', url: 'https://www.donat-mouthpiece.com/' },
  { id: 'editions-lafitan', name: 'Éditions Lafitan', logo: '/logos/partners/editions-lafitan.svg', url: 'https://www.lafitan.com/' },
  { id: 'besson', name: 'Besson London', logo: '/logos/partners/besson.png', url: 'https://www.besson.com/' },
  { id: 'bs-markneukirchen', name: 'B&S Markneukirchen', logo: '/logos/partners/bs-markneukirchen.png', url: 'https://b-and-s.com/' },
  { id: 'antoine-courtois', name: 'Antoine Courtois Paris', logo: '/logos/partners/antoine-courtois.png', url: 'https://www.a-courtois.com/' },
  {
    id: 'johannes-scherzer',
    name: 'Meister Johannes Scherzer',
    logo: '/logos/partners/johannes-scherzer.png',
    url: 'https://www.scherzer-trumpets.com/',
  },
  { id: 'hawkins-mutes', name: 'Hawkins Mutes', logo: '/logos/partners/hawkins-mutes.png', url: 'https://hawkinsmutes.com/' },
  {
    id: 'ic-by-acquisto',
    name: 'IC by Acquisto',
    logo: '/logos/partners/ic-by-acquisto.png',
    // TODO — aucun site trouvé sous ce nom : lien à demander à l'organisation.
    url: null,
  },
  { id: 'js-musique', name: 'JS Musique', logo: '/logos/partners/js-musique.png', url: 'https://www.jsmusique.com/' },
  {
    id: 'le-stock-de-notes',
    name: 'Le Stock de Notes',
    logo: '/logos/partners/le-stock-de-notes.png',
    url: 'https://www.lestockdenotes.com/',
    // TODO — logo rangé avec ceux de JS Musique : partenaire distinct ou enseigne liée ?
  },
  { id: 'slide-to-play', name: 'Slide to Play', logo: '/logos/partners/slide-to-play.png', url: 'https://slidetoplay.fr/' },
  { id: 'trompette-actus', name: 'Trompette Actus', logo: '/logos/partners/trompette-actus.png', url: 'https://trompetteactus.fr/' },
  {
    id: 'amc2',
    name: 'AMC2 — Association Musicale de Caluire et Cuire',
    logo: '/logos/partners/amc2.png',
    url: 'https://www.musicamc2.fr/',
  },
  {
    id: 'ville-de-caluire-et-cuire',
    name: 'Ville de Caluire et Cuire',
    logo: '/logos/partners/ville-de-caluire-et-cuire.png',
  ...
  // suffirait peut-être.
  {
    ...
    logo: '/logos/partners/musique-angillonnaise.png',
  ...
  },
  {
    ...
    logo: '/logos/partners/piston-magazine.png',
